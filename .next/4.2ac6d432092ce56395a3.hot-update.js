  ...
  */
  ...
  _createClass(IcoList, [{
    ...
    value: function getIDfromDetail(id) {
      ...
      //console.log("TRAZA 2");
      console.log(id);
      this.props.getERC20contract(this.props.arrayERC20[id]); //console.log("TRAZA 3");
    ...
    */
    ...
    value: function render() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_bootstrap__["g" /* Table */], {
        responsive: true,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 56
      ...
      }, "Token price (in ether)"))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("tbody", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 66
        }
...
//# sourceMappingURL=4.2ac6d432092ce56395a3.hot-update.js.map