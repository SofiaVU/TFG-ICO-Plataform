          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                theERC20.setProvider(web3.currentProvider); //this.setState({erc20: theERC20});

                console.log("MIERDA");
                console.log(theERC20); // CONTRATO	
...
//# sourceMappingURL=4.f6eaec52b3e18448a158.hot-update.js.map