  ...
  _createClass(App, [{
    ...
    */
    ...
    value: function formCliked(formInfo) {
      ...
      var tokenAddr = this.deployNewERC20(formInfo);
    ...
    */
    ...
    value: function registerNewICO(info, tokenAdd) {
      ...
      console.log(tokenAdd); //register(string name, string opppening, string clossing)
      //register(string name, address token,  string opppening, string clossing)

      this.state.contrato.register(info.icoName, tokenAdd, info.OpeningDate, info.ClossingDate, {
        from: account,
        gas: 2000000
      }).then(function (res) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                _context2.t2 = "TOKEN NAME " + _context2.t1;
                ...
                return _context2.abrupt("return", tokenInstance.address);
...
//# sourceMappingURL=4.c9a3d78dc2d107927645.hot-update.js.map